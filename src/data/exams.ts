...
export const examsData: Record<string, ExamData> = {
  "neet-ug": {
    ...
    name: "NEET UG",
    category: "Medical",
    metaTitle: "NEET UG 2026 — Complete Guide, Syllabus, Dates & Preparation | KMR",
  ...
  "gre": {
    ...
    name: "GRE",
    category: "MS Abroad",
    metaTitle: "GRE 2026 — Complete Guide, Syllabus & Preparation | KMR",
  ...
  "ielts": {
    ...
    name: "IELTS",
    category: "Language",
    metaTitle: "IELTS 2026 — Complete Guide, Tips & Preparation | KMR",
  ...
  "toefl": {
    ...
    name: "TOEFL",
    category: "Language",
    metaTitle: "TOEFL 2026 — Complete Guide & Preparation Tips | KMR",
  ...
  "gmat": {
    ...
    name: "GMAT",
    category: "Business",
    metaTitle: "GMAT 2026 — Complete Guide for MBA Aspirants | KMR",
